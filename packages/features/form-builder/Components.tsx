  ...
  multiemail: {
    ...
    factory: function MultiEmail({ value, readOnly, label, setValue, ...props }) {
      ...
      const inputClassName =
        "dark:placeholder:text-darkgray-600 focus:border-emphasis border-subtle block w-full rounded-md border-default text-sm focus:ring-black disabled:bg-emphasis disabled:hover:cursor-not-allowed dark:selection:bg-green-500 disabled:dark:text-subtle bg-default";
      return (
        <>
          {value.length ? (
            <div>
            ...
            return (
              <label key={i} className="block">
                <input
                  ...
                  className="border-default dark:checked:bg-brand-default dark:bg-darkgray-100 dark:hover:bg-subtle dark:checked:hover:bg-brand-default h-4 w-4 cursor-pointer rounded text-[--cal-brand] ltr:mr-2 rtl:ml-2"
                  value={option.value}
